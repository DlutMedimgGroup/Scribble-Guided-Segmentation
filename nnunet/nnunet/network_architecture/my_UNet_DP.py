...
class my_UNet_DP(my_UNet):
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        As opposed to the my_UNet, this class will compute parts of the loss function in the forward pass. This is
        ...
        """
        super(my_UNet_DP, self).__init__(input_channels, base_num_features, num_classes, num_pool,
                                              num_conv_per_stage,
    ...
    def forward(self, x, y=None, return_hard_tp_fp_fn=False):
        res = super(my_UNet_DP, self).forward(x)  # regular my_UNet forward pass
